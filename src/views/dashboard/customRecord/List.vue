                ...
                <a-layout style="position: absolute; top:0; bottom:0; right:0;  overflow-x: hidden; overflow-y: auto;"
                    ...
                    <a-layout-content>
                        ...
                        <div class="content-hd">
                            ...
                            <a-button @click="showDepartmentList" style="margin: 0 10px">
                            ...
                            <a-spin tip="加载中..." size="large" :spinning="isLoading">
                                <a-table :columns="columns" :dataSource="deleteList" :pagination="false"
                                    ...
                                    <div slot="tag_name" slot-scope="text, record, index">
                                        ...
                                        <span v-if="record.customerInfo.per_name.length == 0 && record.customerInfo.tag_name.length > 5">
                        <a-popover>
                            <span slot="content">
                            ...
                            <span v-for="(item1,index1) in record.customerInfo.tag_name">
                                   <a-tag v-if="index1<5" style="margin-top: 5px;"
                                          color="blue">
												              {{ item1 }}
											            </a-tag>
                            </span>
                            <span>等{{ record.customerInfo.tag_name.length }}个标签</span>
                        </a-popover>
                    </span>
                                        <span v-if="record.customerInfo.per_name.length == 0 && record.customerInfo.tag_name.length <=5">
                         <a-tag v-for="item in record.customerInfo.tag_name" style="margin-top: 5px;"
