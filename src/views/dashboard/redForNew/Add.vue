                  ...
                  <a-form v-if="current == 0">
                    ...
                    >
                      ...
                      <span
                        style="
                          ...
                          color: #f56c6c;
                        "
                        >{{ rule.name === null ? 0 : rule.name.length }} /
                        30</span
                      >
                    ...
                    >
                      <a-radio-group
                        ...
                        :disabled="
                          typeof urlId != 'undefined' && redpacket_status != 1
                        "
                      >
                        ...
                        <a-radio style="margin-left: 25px" :value="2">
                          ...
                          >
                            ...
                            <a-tooltip placement="top">
                              <template slot="title">
                                <span
                                  >在活动时间内，微信支付商户平台账户余额充足情况下，扫码添加企业成员发红包。</span
                                >
                              </template>
                              <a-icon
                    ...
                    >
                      ...
                      <a-tooltip placement="top">
                        <template slot="title">
                          <span
                            >如设置3天，那么，当活动在1号结束，2号、3号及4号依然可以扫码加人，但不发红包，5号凌晨则扫码失效，即提示“扫码不存在”。若手动提前结束活动，则以结束当日后往后延3天，如原本是在5号结束，但3号时提前结束，那么，在7号凌晨扫码失效。</span
                          >
                        </template>
                        <a-icon
                          type="question-circle"
                    ...
                    >
                      ...
                      <a-form
                        ...
                        v-if="
                          (rule.redrule_type == 1 && rule.rule_id) ||
                          rule.redrule_type == 2
                        "
                      >
                        <a-form-item
                        ...
                        >
                          ...
                          >
                            <span v-if="rule.redrule_type == 2" slot="suffix">
                              <span>{{ rule2.rule_name.length }}</span
                              >/30
                            </span>
                          </a-input>
                          <span v-if="rule.redrule_type == 1">{{
                            rule1.rule_name
                          }}</span>
                        </a-form-item>
                        <a-form-item
                        ...
                        >
                            ...
                            >
                              ...
                              <span v-if="rule2.rule_type == 1">
                                <a-input-number
                                  ...
                                  :min="0.3"
                                  :max="200.0"
                                  v-model="rule2.rule_fixed_amount"
                                />元
                              </span>
                            </a-radio>
                            <a-radio
                            ...
                            >
                              ...
                              <span v-if="rule2.rule_type == 2">
                                <a-input-number
                                  ...
                                  :min="0.3"
                                  :max="200.0"
                                  v-model="rule2.rule_min_random_amount"
                                />元 ——
                                <a-input-number
                                  :step="0"
                                  :precision="2"
                                  ...
                                  :min="0.3"
                                  :max="200.0"
                                  v-model="rule2.rule_max_random_amount"
                                />元
                              </span>
                            </a-radio>
                          </a-radio-group>
                          <a-radio-group
                            ...
                            v-if="rule.redrule_type == 1"
                            :disabled="
                              rule.redrule_type == 1 || redpacket_status != 1
                            "
                          ...
                          >
                            ...
                            >
                              定额
                              <span v-if="rule1.rule_type == 1"
                                >{{ rule1.rule_fixed_amount }}元</span
                              >
                            </a-radio>
                            <a-radio
                              :value="2"
                            ...
                            >
                              按随机金额
                              <span v-if="rule1.rule_type == 2"
                                >{{ rule1.rule_min_random_amount }}-{{
                                  rule1.rule_max_random_amount
                                }}元</span
                              >
                            </a-radio>
                          </a-radio-group>
                        ...
                        >
                          ...
                          <img
                            v-if="rule1.rule_pic_url && rule.redrule_type == 1"
                            style="max-width: 128px; max-height: 128px"
                        ...
                        >
                          ...
                          >
                            <span slot="suffix">
                              <span>{{ rule2.rule_title.length }}</span
                              >/32
                            </span>
                          </a-input>
                          <span v-if="rule.redrule_type == 1">{{
                        ...
                        >
                          ...
                          <div
                            ...
                            v-if="
                              rule.redrule_type == 2 && redpacket_status == 1
                            "
                          >
                            <span>{{ rule2.rule_des.length }}</span
                            >/128
                          </div>
                          <span
                            v-if="
                        ...
                        >
                          ...
                          >
                            <span slot="suffix">
                              <span>{{ rule2.rule_thanking.length }}</span
                              >/32
                            </span>
                          </a-input>
                          <span v-if="rule.redrule_type == 1">{{
                            rule1.rule_thanking || "恭喜发财，大吉大利"
                          }}</span>
                        </a-form-item>
                      </a-form>
                    </a-form-item>
                    ...
                    >
                      <a-switch
                        :disabled="redpacket_status != 1"
                        :checked="rule.rule_save == 1"
                        @click="changeRuleSave"
                      ></a-switch>
                    </a-form-item>
                    <a-form-item
                      label="投放金额"
                    ...
                    >
                      ...
                      />
                      元（精确到小数点后两位，可输入0.30~100000.00。发送红包达到这个数额之后，对下一个新客户不再推送。<span
                        style="color: #ff562d"
                        >只可增加不可减少</span
                      >）
                      <p>
                        最多领取人数可达<span style="color: #ff562d">
    ...
    >
      <div>
        <div style="margin-bottom: 10px">
          ...
          <a-button style="margin-left: 10px" type="primary" @click="searchName"
            >搜索</a-button
          >
...
export default {
  ...
  methods: {
    ...
    changeRedStartTime(date, dateString) {
      if (
        dateString &&
        this.startDate &&
        dateString > moment(this.endDate).format("YYYY-MM-DD HH:mm:ss")
      ) {
    ...
    changeRedEndTime(date, dateString) {
      if (
        dateString &&
        this.startDate &&
        dateString < moment(this.startDate).format("YYYY-MM-DD HH:mm:ss")
      ) {
    ...
    checkedOut(index) {
      ...
      if (index == 0) {
        ...
        if (
          this.rule.time_type == 2 &&
          (this.rule.end_time == "" || this.rule.start_time == "")
        ) {
          this.$message.destroy();
        ...
        if (this.rule.redrule_type == 1) {
          ...
          if (this.rule1.rule_type == 2) {
            if (
              this.rule.redpacket_amount <= this.rule1.rule_min_random_amount
            ) {
              this.$message.destroy();
              this.$message.warning("投放金额不能小于单个红包金额");
              return false;
          ...
          if (this.rule2.rule_type == 2) {
            if (
              !this.rule2.rule_min_random_amount ||
              !this.rule2.rule_max_random_amount
            ) {
              this.$message.destroy();
              this.$message.warning("请输入红包金额");
              return false;
              ...
              this.rule.redpacket_amount < this.rule2.rule_min_random_amount
            ) {
              this.$message.destroy();
              this.$message.warning("投放金额不能小于单个红包金额");
              return false;
    ...
    async saveWay() {
      ...
      ruleContent.rule_thanking =
        ruleContent.rule_thanking || "恭喜发财，大吉大利";
    ...
    async getDetail() {
      const { data: res } = await this.axios.post(
        "work-contact-way-redpacket/get-redpacket-info",
        {
          corp_id: this.corpId,
          uid: localStorage.getItem("uid"),
          id: this.urlId,
  ...
  created() {
    ...
    if (typeof this.urlId != "undefined") {
      ...
      this.corpName = this.$store.state.corpArr.find(
        (corp) => corp.corpid == this.corpId
      ).corp_name;
      this.isLoading = true;
      //不允许修改企业微信或公众号
