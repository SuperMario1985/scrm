                ...
                <a-layout style="position: absolute;top:0;bottom:0;right:0;" class="scroll"
                    ...
                    <a-layout-content>
                        ...
                        <div class="content-hd">
                            <a-button @click="showDepartmentList(true,0,0)">
                                选择部门成员
                            </a-button>
                            ...
                            <a-spin tip="加载中..." size="large" :spinning="isLoading">
                                ...
                                >
                                    ...
                                    <div slot="action" slot-scope="text, record, index">
                                        ...
                                        <a-button
                                            ...
                                            style="margin: 0px 5px 5px 0px;"
                                            @click="bulkChangeLimit(0, 1,record.user_id,record)"
                                ...
                                <div style="margin: 20px;" v-show="total > 0" v-has="'employee-limit'">
                                    ...
                                    <a-button type="primary"
                                              @click="bulkChangeLimit(1, selectedRowKeys.length,selectedRowKeys)"
                        ...
                        <a-modal title="限额发放" v-model="setVisible" @ok="setHandleOk"
                            ...
                            <a-row style="margin-bottom: 12px" v-if="!isSingle">
                                <a-button @click="showDepartmentList(false,1,1)">
                                    选择部门成员
                                </a-button>
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                isSingle            : false,
                isSearch            : false,
                departmentDisabled  : 0,//部门是否直接禁选,1禁选
        ...
        methods : {
            ...
            //部门选择弹窗组件
            showDepartmentList (isSearch, userSendMoney, departmentDisabled) {
                this.userSendMoney = userSendMoney
                this.isSearch = isSearch
                this.departmentDisabled = departmentDisabled

                let CheckList = this.checkedList1
                let CheckUser = this.user1
                if (isSearch) {
            ...
            //批量零钱限额
            bulkChangeLimit (type, people, user_ids, record) {

                this.isSingle = true
                if (type == 1) {
                    this.checkedList1 = user_ids
                } else {
                    this.checkedList1 = [user_ids]
                }
                if (record) {
