  ...
  <div class="app-center">
    ...
    >
      ...
      <a-form>
        ...
        <div
          style="color: #ff562d; margin-bottom: 10px; margin-left: 16.66%"
          v-if="storeType == 1"
        >
        ...
        <div class="content-msg" v-if="storeType == 1">
          <p style="margin-bottom: 2px; line-height: 25px">
            1，请登录<a
              :href="
                $store.state.cashierUrl +
                '/cashier/merchants.php?m=Index&c=login&a=index'
              "
              target="_blank"
              >智慧店铺系统</a
            >--商家配置--商家资料--复制标识
        ...
        <div class="content-msg" v-if="storeType == 2">
          <p style="margin-bottom: 2px; line-height: 25px">
            1、打通有赞，需先在有赞服务市场购买【云美来CRM】应用，<a
              href="https://yingyong.youzan.com/cloud-app-detail/51319"
              target="_blank"
              >前往订购地址</a
            >
          </p>
        ...
        <div
          v-if="storeType == 3 || storeType == 4"
          style="margin-left: 16.7%; color: #ff562d"
        >
          创建好店铺后，进入【店铺订单】导入<span v-if="storeType == 3"
            >淘宝</span
          ><span v-if="storeType == 4">天猫</span
          >订单，仅支持csv格式，文件大小20M以内。
        </div>
...
export default {
  ...
  methods: {
    ...
    setWidth() {
      let screenWidth = document.getElementsByClassName("app-list")[0]
        .clientWidth;
  ...
  mounted() {
    let that = this;
    this.getAppList();
    window.addEventListener("resize", that.setWidth, false);
