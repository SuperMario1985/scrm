    ...
    <div class="mobile_menu_preview">
      ...
      <div class="menus">
        ...
        <div class="flex" v-else>
          <div class="keyboard"><i class="fa fa-keyboard-o" aria-hidden="true"></i></div>
          <menuFirst  :lockToContainerEdges="true" class="flex-1" axis="xy" @sort-start="start" @sort-end="end" @input="changesort"  v-model="menu">
...
name: "menuList",
  ...
  methods:{
    ...
    changesort(newVal){
      this.$store.commit('updateMenuList',newVal)
    ...
    start(e){
      ...
      console.log(e,'newValnewVal')
      end = Number(new Date())
      let newV = e.newIndex,old = e.oldIndex
      this.$store.commit('updateActiveMenu',newV)
      // this.$store.commit('updateCurrentMenu',this.menulist[newV])
