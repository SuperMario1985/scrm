              ...
              <template slot="content">
                <div @mouseover="clearLeave" @mouseleave="hideMoreIcon1">
                  ...
                  <p
                    ...
                    v-has="'groupAutoCreate-group-del'"
                  >
                    删除分组
                  </p>
                  <p
  ...
  created() {
    if (localStorage.getItem("permissionButton") == "all") {
      ...
      let permissionButton = localStorage
        ...
        .split(",");
      if (
        permissionButton.indexOf("groupAutoCreate-group-add") == -1 &&
        permissionButton.indexOf("groupAutoCreate-group-edit") == -1 &&
        permissionButton.indexOf("groupAutoCreate-group-del") == -1
      ) {
    ...
    removeGroup(key, title) {
      ...
      that.$confirm({
        title:
          "【" +
          title +
          "】一旦删除，归属于该分组的信息都将被移至【未分组】，确定删除分组吗?",
        okText: "确定",
        okType: "primary",
        cancelText: "取消",
        onOk() {
