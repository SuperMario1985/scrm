	...
	export default {
				...
				handler (newVal, oldVal) {
					if (this.options) {
						if (newVal) {
							...
							this.option.tooltip.formatter = newVal.formatter
		...
		mounted () {
			...
			if (this.options.data_Type == 1) {
				...
				if (this.options.data_Type == 5) {
					this.option.toolbox.feature.saveAsImage.show = false
					this.option.title.show = false
					this.option.tooltip.show = false
					this.option.grid.show = false
